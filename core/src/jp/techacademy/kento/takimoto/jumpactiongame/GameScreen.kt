...
class GameScreen(private val mGame: JumpActionGame) : ScreenAdapter() {
    ...
    var sound = Gdx.audio.newSound(Gdx.files.internal("zannense.mp3"))
    ...
    private var mEnemies: ArrayList<Enemy> //課題add
    ...
    init {
        ...
        mEnemies = ArrayList<Enemy>() //課題add
    ...
    private fun createStage() {
        ...
        val enemyTexture = Texture("akaoni.png") //課題 add
